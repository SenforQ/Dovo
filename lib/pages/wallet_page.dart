...
final List<CoinProduct> kCoinProducts = [
  CoinProduct(productId: 'Dovo', coins: 32, price: 0.99, priceText: '\$0.99'),
  CoinProduct(productId: 'Dovo1', coins: 60, price: 1.99, priceText: '\$1.99'),
  CoinProduct(productId: 'Dovo2', coins: 96, price: 2.99, priceText: '\$2.99'),
  CoinProduct(productId: 'Dovo4', coins: 155, price: 4.99, priceText: '\$4.99'),
  CoinProduct(productId: 'Dovo5', coins: 189, price: 5.99, priceText: '\$5.99'),
  CoinProduct(productId: 'Dovo9', coins: 359, price: 9.99, priceText: '\$9.99'),
  CoinProduct(productId: 'Dovo19', coins: 729, price: 19.99, priceText: '\$19.99'),
  CoinProduct(productId: 'Dovo49', coins: 1869, price: 49.99, priceText: '\$49.99'),
  CoinProduct(productId: 'Dovo99', coins: 3799, price: 99.99, priceText: '\$99.99'),
  CoinProduct(productId: 'Dovo159', coins: 5999, price: 159.99, priceText: '\$159.99'),
  CoinProduct(productId: 'Dovo239', coins: 9059, price: 239.99, priceText: '\$239.99'), 
];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              SizedBox(height: safeAreaTop > 0 ? 20 : 40),
              // 余额显示区域
              Column(
                children: [
                  // 余额数字
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              _buildCoinInfoRule(
                '1',
                'Creating a gift idea costs 200 coins each time.',
              ),
              const SizedBox(height: 16),
              _buildCoinInfoRule(
                '2',
                'Unlock other peoples gift ideas for 200 coins',
              ),
              const SizedBox(height: 16),
              _buildCoinInfoRule(
                '3',
