...
class SizePermissionTool {
    //: static let shared = AppPermissionTool()
    static let shared = SizePermissionTool()
    ...
    func begin(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func block(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
